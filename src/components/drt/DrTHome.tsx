    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden flex flex-col min-h-[460px]">
            ...
            <div className="p-4 bg-slate-50/80 border-b border-slate-100 flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className="px-2.5 py-1 rounded-xl bg-white hover:bg-slate-100 text-slate-700 text-xs font-semibold border border-slate-200 transition flex items-center space-x-1"
                >
            ...
            <div className="flex-1 p-6 overflow-y-auto space-y-6 max-h-[520px]">
                  ...
                  {msg.role === 'model' && (
                    <div className="flex items-center space-x-2 pl-2">
                      ...
                      <button
                        ...
                        className="text-[11px] font-semibold text-teal-700 hover:text-teal-900 transition flex items-center space-x-1"
                      >
              ...
              {isLoading && (
                <div className="flex items-center space-x-2.5 text-slate-500 text-xs font-semibold p-4 bg-slate-50 rounded-2xl border border-slate-200/80 animate-pulse max-w-sm">
        ...
        <div className="lg:col-span-4 space-y-5">
          ...
          <div className="p-5 rounded-3xl bg-slate-900 text-white space-y-3 shadow-sm">
            <div className="flex items-center justify-between">
            ...
            <div className="space-y-2 text-xs">
              <div className="flex items-center justify-between py-1 border-b border-slate-800">
                <span className="text-slate-300">Apple Health & Oura Ring</span>
                <span className="text-slate-400 font-mono text-[11px]">Sync 8 mins ago</span>
              </div>
              <div className="flex items-center justify-between py-1 border-b border-slate-800">
                <span className="text-slate-300">Quest Diagnostics (Labs)</span>
                <span className="text-slate-400 font-mono text-[11px]">Aug 25, 2026</span>
              </div>
              <div className="flex items-center justify-between py-1">
                <span className="text-slate-300">HL7 FHIR R4 Interop Hub</span>
                <span className="text-teal-400 font-mono text-[11px]">Connected</span>
              </div>
            </div>
          </div>
